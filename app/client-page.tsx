      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-neutral-800/40">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            {/* ===== ИСПРАВЛЕННЫЙ БЛОК «ПРЕИМУЩЕСТВА СЕРВИСА» ===== */}
            <div className="bg-gradient-to-b from-neutral-900 to-neutral-950 p-6 sm:p-8 rounded-3xl border border-neutral-800 shadow-xl">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 text-center divide-x divide-neutral-800/80">
                <div className="min-w-0 px-1 sm:px-4 flex flex-col items-center">
                  <div className="text-lg sm:text-4xl font-black text-white font-mono mb-1">
                    {t.achievements[0].num}
                  </div>
                  <div
                    lang={lang}
                  ...
                  >
                    {t.achievements[0].label}
                  </div>
                </div>

                <div className="min-w-0 px-1 sm:px-4 flex flex-col items-center">
                  <div className="text-lg sm:text-4xl font-black text-amber-400 font-mono mb-1">
                    {t.achievements[1].num}
                  </div>
                  <div
                    lang={lang}
                    className="w-full text-[9px] sm:text-xs text-neutral-400 uppercase tracking-normal sm:tracking-wide leading-tight break-words [hyphens:auto]"
                  >
                    {t.achievements[1].label}
                  </div>
                </div>

                <div className="min-w-0 px-1 sm:px-4 flex flex-col items-center">
                  <div className="text-sm sm:text-2xl font-bold text-white mb-1 break-words">
                    {t.achievements[2].num}
                  </div>
                  <div
                    lang={lang}
                    className="w-full text-[9px] sm:text-xs text-neutral-400 uppercase tracking-normal sm:tracking-wide leading-tight break-words [hyphens:auto]"
                  >
                    {t.achievements[2].label}
                  </div>
                </div>
              </div>
            </div>
